...
const plans = [
  {
    ...
    features: ["5 AI-powered analyses", "5 site crawls (up to 5K pages)", "5 batch PageSpeed runs", "CSV exports"],
  },
  {
    name: "Pro",
    credits: 25,
    ...
    features: ["25 AI-powered analyses", "25 site crawls (up to 5K pages)", "25 batch PageSpeed runs", "CSV exports", "Priority processing"],
  },
  {
    name: "Enterprise",
    credits: 100,
    ...
    features: ["100 AI-powered analyses", "100 site crawls (up to 5K pages)", "100 batch PageSpeed runs", "CSV exports", "Priority processing", "Best value per credit"],
  },
];
          ...
          <div key={plan.variantId} style={{
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 24px", fontSize: 13, color: "#cbd5e1" }}>
              {plan.features.map((f, i) => (
                <li key={i} style={{ padding: "5px 0", borderBottom: "1px solid #1e2a42" }}>&#10003; {f}</li>
              ))}
            </ul>
            <button onClick={() => handleBuy(plan.variantId)} disabled={loading === plan.variantId} style={{
